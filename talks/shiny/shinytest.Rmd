---
title: Interactive illustration of unimodal assumption
runtime: shiny
...
## Illustration of unimodal assumption
Increase the proportion of nulls until the alternative (cyan) looks unimodal.
```{r, echo=FALSE}
