#todo
# provide a way to get estimate of pi0
# provide a "method" that sets defaults for shrinkage vs fdr
# think about what output should be for localfdr vs localfsr with and without point mass
#
