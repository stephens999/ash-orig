...
```{r}
  loglikEE=ashr:::loglik.ash(ash1.res, betahat, betahat.se,df=NULL, zscore=FALSE) 
  loglikES=ashr:::loglik.ash(ash2.res,betahat, betahat.se, df=NULL, zscore=TRUE)
  loglikEE-loglikES
```
...
To finish, we illustrate that if we generate data under the EE model then that model
