...
\begin{subtable}{\textwidth}
	\input{tables/coverage_all.tex}
	\caption{All}
\end{subtable}

\begin{subtable}{\textwidth}
\input{tables/coverage_neg.tex}
\caption{Negative findings}
\end{subtable}

\begin{subtable}{\textwidth}
\input{tables/coverage_pos.tex}
\caption{Positive findings}
\end{subtable}

\caption{Table of 5\% lower tail coverage rates by scenario and method}
\end{table}
