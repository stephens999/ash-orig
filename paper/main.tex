...
Thus, are two reasons to use the lfsr instead of the lfdr: it is more generally meaningful (e.g. it applies
...
\begin{figure}
\begin{subfigure}{\textwidth}
\centering\includegraphics[width=4in]{Rcode/figures/GOODPOOReg_hist.pdf} 
 ...
 \end{subfigure}
\begin{subfigure}{\textwidth}
\centering\includegraphics[width=4in]{Rcode/figures/GOODPOOReg_scatter.pdf}
