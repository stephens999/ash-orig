...
PENN Note: need to fix bug in dscr where when an element of result is null, the data.frame command doesn't work.
Want to convert it to missing - maybe in the scoring function.
