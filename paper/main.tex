...
moving focus away from ``type I errors" towards ``type S errors", meaning errors in sign. 
...
which can lead to measures of significance analogous to Storey's $q$ values for example. See Appendix \ref{} for details, which also outlines 
frequentist versions of the false sign rate.
