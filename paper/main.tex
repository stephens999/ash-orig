...
reasonably good precision ($s_j = 1$) and half the observations have very poor precision ($s_j=10$). In both cases,
...
\begin{figure}
\center \includegraphics[width=6.5in]{Rcode/figures/GOODPOOReg_hist.pdf} \\
\center \includegraphics[width=6.5in]{Rcode/figures/GOODPOOReg_scatter.pdf}
\caption{Illustration of the way that high-noise observations can contaminate signal from low-noise observations.} \label{fig:GOODPOOR}
\end{figure}
