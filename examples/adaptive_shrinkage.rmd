...
```{r run-ash-ES}
beta.bignormal.ash.ES = ash(sim.bignormal$input$betahat, s,model="ES",mixcompdist="normal")
beta.spiky.ash.ES = ash(sim.spiky$input$betahat, s,model="ES",mixcompdist="normal")
df.ES = make_df_for_ashplot(sim.spiky,sim.bignormal,beta.spiky.ash.ES,beta.bignormal.ash.ES)
ashplot(df.ES,ylab="Shrunken beta estimate (ES model)")
pval_plot(df.ES)
```
